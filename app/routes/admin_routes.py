...
def register_admin_routes(
    ...
    *,
    ...
    @app.get('/diagnostics/surfaced-checkpoint-visual-review-pack.zip')
    def diagnostics_surfaced_checkpoint_visual_review_pack() -> Response:
        from app.services.evidence_pack import pack_to_zip_bytes
        ...
        return Response(
            content=content,
            media_type='application/zip',
            headers={'Content-Disposition': 'attachment; filename=surfaced_checkpoint_visual_review_pack_last_10_sessions.zip'},
        )

    @app.get('/diagnostics/surfaced-multisession-visual-review-pack.zip')
    def diagnostics_surfaced_multisession_visual_review_pack() -> Response:
        from app.services.evidence_pack import pack_to_zip_bytes
        ...
        return Response(
            content=content,
            media_type='application/zip',
            headers={'Content-Disposition': 'attachment; filename=surfaced_multisession_visual_review_pack_last_10_sessions.zip'},
        )
